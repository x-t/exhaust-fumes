  ...
  const renderGadgetsNodes = () => {
    return Object.entries(gadgets).map(([key, value]) => {
      ...
      return (
        <>
          {React.createElement(
            value.settingsNode as React.FunctionComponent,
            {
              settings: state,
              setSettings: setState,
              key: `${key}-SettingsNode`,
            } as React.Attributes,
            null
          )}
          <hr />
      ...
      <div className="SettingsPanelContent">
        ...
        <BackgroundContext.Consumer>
          {(value) =>
            value.isOverriden ? (
              <div>
                <p>Background Image is being overriden by a gadget.</p>
              </div>
            ) : (
              <div className="SettingsNode">
        ...
        <div className="SettingsCopyright">
          ...
          <div>
            Icons for Weather Gadget made by{" "}
            <a
          ...
          <div>
            Other icons (Wrench, Times) made by{" "}
            <a href="https://fontawesome.com/">FontAwesome</a>
          </div>
          <div>
            After Dark screensavers provided by{" "}
            <a href="https://github.com/bryanbraun/after-dark-css">
              bryanbraun/after-dark-css
            </a>
          </div>
          <div>
            Built with React and third-party modules.{" "}
            <a href="https://github.com/x-t/exhaust-fumes">Source code</a>
          </div>
        </div>
      </div>
    </div>
